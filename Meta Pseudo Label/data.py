...
def get_cifar10(args):
    ...
    transform_fintune = transforms.Compose([
        transforms.RandomHorizontalFlip(),
        transforms.RandomCrop(size=args.resize,
                              padding=int(args.resize * 0.125),
                              fill=128,
    ...
    train_labeled_idxs, train_unlabeled_idxs, fintune_idxs = x_u_split(
    ...
    fintune_dataset = CIFAR10SSL(
        args.data_path, fintune_idxs, train=True,
    ...
    test_dataset = datasets.CIFAR10(
        args.data_path, train=False, transform=transform_val, download=False)

    return train_labeled_dataset, train_unlabeled_dataset, test_dataset, fintune_dataset
